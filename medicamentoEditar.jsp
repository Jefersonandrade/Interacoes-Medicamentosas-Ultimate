...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="domainModel.Medicamento, java.util.*" %>
				...
				<tr>
				  <td><table width="100%" border="1" cellpadding="2" cellspacing="0">
					...
					<tr>
					  ...
					  <td><input name="num_registro" type="text" id="num_registro" size="25" maxlength="45" value="<% if(medicamento != null){ out.print(medicamento.getNumregistro()); } %>" />
					  * Validade: 
