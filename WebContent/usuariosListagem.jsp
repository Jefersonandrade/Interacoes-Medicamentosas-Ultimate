		...
		<table>
			<tr>
				<td align="center">
					...
					<a href="/InteracoesMedicamentosas/Usuario?edit=new">
		...
		while(it.hasNext()){
			...
			%>
				<tr>
					...
					<td><%=u.getNome() %></td>			
					<td align="center">
						<a href="/InteracoesMedicamentosas/Usuarios?edit=<%=u.getId() %>"><img title="editar" alt="editar" src="images/editar.png"/></a>
						<a href="/InteracoesMedicamentosas/Usuarios?del=<%=u.getId() %>"><img title="Desabilitar" alt="Desabilitar" src="images/bloquear.png" /></a>
					</td>
