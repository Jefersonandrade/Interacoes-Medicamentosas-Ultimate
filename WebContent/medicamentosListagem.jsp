		...
		<table>
			<tr>
				<td align="center">
					...
					<a href="/InteracoesMedicamentosas/Medicamento?edit=new">
		...
		while(it.hasNext()){
			...
			%>
				<tr>
					...
					<td align="center">
						<a href="/InteracoesMedicamentosas/Medicamentos?edit=<%=m.getId() %>"><img title="editar" alt="editar" src="images/editar.png"/></a>
						<a href="/InteracoesMedicamentosas/Medicamentos?del=<%=m.getId() %>"><img title="Desabilitar" alt="Desabilitar" src="images/bloquear.png" /></a>
					</td>
