		...
		<table>
			<tr>
				<td align="center">
					...
					<a href="/InteracoesMedicamentosas/Fabricante?edit=new">
...
<table>
    ...
    <tr>
		...
		while(it.hasNext()){
			Fabricante fa = (Fabricante)it.next();
			%>
				<tr>
					<td><%=fa.getId() %></td>
					<td><%=fa.getNomefantasia() %></td>			
					<td align="center">
						<a href="/InteracoesMedicamentosas/Fabricantes?edit=<%=fa.getId() %>"><img title="editar" alt="editar" src="images/editar.png"/></a>
						<a href="/InteracoesMedicamentosas/Fabricantes?del=<%=fa.getId() %>"><img title="Desabilitar" alt="Desabilitar" src="images/bloquear.png" /></a>
					</td>
				</tr>
			<%
		}
